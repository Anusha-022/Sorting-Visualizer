...
{
    int i;
    cout<<endl<<" Enter the no of elements to sort: ";
    cin>>no_of_elements;
...
void display_blocks(int values[])
{
     ...
     for(int i=0; i<no_of_elements; i++)
    {
        ...
        setfillstyle(1,color[i]);
            ...
            // for spacing between the blocks we have chosen
            // the spacing between the blocs as 10
...
int main()
{
    ...
    initwindow(1380,1200,"Sorting Visualizer");
    settextstyle(8,0,3);
    while(1)
    {
        system("CLS");
   ...
   wprintf(L"\x1b[35;107m                                      WELCOME TO THE WORLD OF VISUALIZING SORTING ALGORITHM                                       \r\n\n");
    wprintf(L"\x1b[31;107m--------------------------------------------------------MENU----------------------------------------------------------\r\n\n");
   // wprintf(L"\x1b[33mPRESS 1: FOR VISUALIZING THE ALGORITHMS\r\n\n");
  ...
  //  cout<<"PRESS 1: FOR BUBBLE SORT"<<endl;
        ...
        for(int i=0; i<no_of_elements-1; i++ )
    {
        ...
        // delaying time showing and delaying before the swap
        delay(1000);
